...
MOTHER_LANGUAGE = {
    ...
    "ボスニア・ヘルツェゴビナ": ["ボスニア語", "クロアチア語", "セルビア語"],
    "ポーランド": ["ポーランド語"],
    "ポルトガル": ["ポルトガル語"],
    ...
    "グレナダ": ["英語"],
    "ベリーズ": ["英語"],
    "グリーンランド": ["グリーンランド語", "デンマーク語"],
    "アルゼンチン": ["スペイン語"],
    "ボリビア": ["スペイン語", "ケチュア語", "アイマラ語", "グアラニー語"],
    "ブラジル": ["ポルトガル語"],
    "チリ": ["スペイン語"],
    "コロンビア": ["スペイン語"],
    "エクアドル": ["スペイン語"],
    ...
    "ウガンダ": ["英語", "スワヒリ語"],
    "ザンビア": ["英語"],
    "ジンバブエ": ["英語", "ショナ語", "北ンデベレ語"],
    "サハラ・アラブ民主共和国": ["アラビア語"],
    "オーストラリア": ["英語"],
    "ニュージーランド": ["英語", "マオリ語"],
    "パプアニューギニア": ["英語", "トク・ピシン", "ヒリモトゥ語"],
    "フィジー": ["英語", "フィジー語", "ヒンディー語"],
    "ソロモン諸島": ["英語", "ソロモン諸島ピジン語"],
    "バヌアツ": ["ビスラマ語", "英語", "フランス語"],
    "サモア": ["サモア語", "英語"],
    "トンガ": ["トンガ語", "英語"],
    "キリバス": ["キリバス語", "英語"],
...
def create_student():
    ...
    if request.method == "POST":
        ...
        if error_message:
            ...
            return render_template("student/create.html", staff_list=Staff.query.all(), region_data=REGION_DATA, mother_language_data=MOTHER_LANGUAGE, google_maps_api_key=current_app.config.get("GOOGLE_MAPS_API_KEY"))
    ...
    return render_template("student/create.html", staff_list=staff_list, region_data=REGION_DATA, mother_language_data=MOTHER_LANGUAGE, google_maps_api_key=current_app.config.get("GOOGLE_MAPS_API_KEY"))
...
def update_student(id):
    ...
    if request.method == "POST":
        ...
        if file and file.filename:
            ...
            if error_message:
                flash(error_message, "danger")
                return render_template("student/edit.html", student=student, staff_list=Staff.query.all(), region_data=REGION_DATA, mother_language_data=MOTHER_LANGUAGE, google_maps_api_key=current_app.config.get("GOOGLE_MAPS_API_KEY"))
            if face_photo_path:
